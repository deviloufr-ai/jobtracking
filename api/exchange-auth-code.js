// Exchange Google authorization code for tokens (access + refresh)
// This enables automatic token refresh without user interaction
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // refresh_token: long-lived, can be used to get new access tokens
