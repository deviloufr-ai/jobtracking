...
export const FLAGS = {
  ...
  // The "E — Focus + List" layout (left nav rail + master-detail drawer) is now
  // the DEFAULT. This is a "disable" flag: absent/false = new design (default),
  // set it true to fall back to the legacy top-header layout.
