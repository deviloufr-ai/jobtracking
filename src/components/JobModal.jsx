        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              />
              {urlWarning && <p className="text-xs text-orange-500 mt-1">⚠ URL invalide (doit commencer par http)</p>}
            </div>
            <div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              placeholder="Contexte, contacts, impressions..."
              value={form.notes}
