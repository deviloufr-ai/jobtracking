        ...
        <div className="bg-white rounded-xl max-w-4xl w-full mx-4 p-8 shadow-2xl">
          ...
          <div className="prose prose-sm max-w-none text-gray-700 space-y-6">
            <section>
              ...
              <p>
                En accédant et en utilisant SmartJobTracker (l'« Application »), vous acceptez d'être lié par ces Conditions d'Utilisation. Si vous n'acceptez pas ces conditions, vous ne devez pas utiliser l'Application.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                SmartJobTracker vous accorde une licence limitée, non-exclusive et révocable pour utiliser l'Application à titre personnel et non-commercial. Vous n'avez pas le droit de:
              </p>
            ...
            <section>
              ...
              <p>
                En uploadant du contenu, vous accordez à SmartJobTracker une licence pour stocker, afficher et traiter ce contenu pour fournir l'Application, y compris:
              </p>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              ...
              <p>
                <strong>Fourni « Tel Quel »:</strong> SmartJobTracker est fourni sans garantie de quelque sorte. Nous ne garantissons pas:
              </p>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <p>
                En aucun cas SmartJobTracker ne sera responsable pour les dommages indirects, accidentels, spéciaux ou consécutifs (y compris les pertes de profits, de données ou d'opportunités d'emploi) même si informé de la possibilité de tels dommages.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Vous acceptez d'indemniser et de défendre SmartJobTracker contre les réclamations, dommages, pertes ou dépenses (y compris les frais d'avocat) découlant de:
              </p>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              ...
              <p>
                Vous pouvez arrêter d'utiliser l'Application à tout moment. SmartJobTracker peut résilier votre accès:
              </p>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              ...
              <p>
                SmartJobTracker est fourni sur une base « best effort ». Nous n'offrons aucune garantie de disponibilité continue. L'Application peut être indisponible pour:
              </p>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              ...
              <p>
                « SmartJobTracker » et le logo sont des marques d'Alexandre Leblanc. Vous n'avez pas le droit d'utiliser ces marques sans permission écrite.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                SmartJobTracker ne peut pas être tenu responsable de la perte de données, même si nous les stockons.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                SmartJobTracker peut modifier ces Conditions à tout moment. Les changements entrent en vigueur immédiatement après publication. Votre utilisation continue implique l'acceptation des changements.
              </p>
            </section>
