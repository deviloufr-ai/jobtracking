        ...
        <div className="bg-white rounded-xl max-w-4xl w-full mx-4 p-8 shadow-2xl">
          ...
          <div className="prose prose-sm max-w-none text-gray-700 space-y-6">
            <section>
              ...
              <p>
                SmartJobTracker (« l'Application ») est engagée à protéger votre vie privée. Cette Politique de Confidentialité explique comment nous collectons, utilisons, divulguons et traitons vos données personnelles.
              </p>
              <p>
            ...
            <section>
              ...
              <p>
                <strong>Pas de cookies de tracking.</strong> SmartJobTracker n'utilise pas de cookies pour vous tracker ou vous profiler. Les données stockées le sont uniquement pour la fonctionnalité de l'app.
              </p>
              <p className="mt-2">
            ...
            <section>
              ...
              <p>
                SmartJobTracker respecte le RGPD (Règlement Général sur la Protection des Données) pour les utilisateurs en Europe et les lois de confidentialité applicables dans votre juridiction.
              </p>
              <p className="mt-2">
