export const fr = {
  ...
  // Carte mentale d’entretien (thèmes → mots-clés → histoires, questions & repères STAR)
  mindMap: {
    title: 'Carte mentale d’entretien',
    subtitle: 'Votre préparation sur une page : thèmes → mots-clés → l’histoire que chaque mot-clé déclenche. Retenez une poignée de mots-clés et chaque question vous ramène à une réponse.',
    empty: 'Construisez une carte mémoire de vos histoires pour cet entretien.',
    sources: 'Utilise votre CV, {stars} réponse(s) STAR enregistrée(s) et {examples} question(s) d’exemple de cette candidature.',
    generate: 'Construire ma carte',
    generating: 'Cartographie de vos histoires…',
    failed: 'Impossible de construire la carte. Réessayez.',
    saved: 'Enregistrée sur cette candidature',
    reset: 'Réinitialiser',
    resetConfirm: 'Supprimer cette carte mentale ? Vous pourrez en construire une nouvelle.',
    resetDone: 'Carte réinitialisée',
    pitch: 'Votre accroche — « parlez-moi de vous »',
    mnemonic: 'Clé mémoire — une lettre par thème',
    viewMap: 'Carte',
    viewOutline: 'Plan',
    viewDrill: 'Entraînement',
    recall: 'Test de mémoire',
    recallHint: 'Mots-clés masqués. Dites chacun (et son histoire) à voix haute, puis touchez pour vérifier.',
    tapToCheck: 'touchez pour vérifier',
    pickKeyword: 'Touchez un mot-clé pour voir les questions auxquelles il répond et les repères STAR pour le raconter.',
    story: 'Histoire',
    answers: 'Répond à ces questions',
    proof: 'Preuve',
    drillPrompt: 'Quel mot-clé répond à cette question ?',
    drillReveal: 'Voir la réponse',
    drillAgain: 'À revoir',
    drillGot: 'Acquis',
    drillProgress: '{left} restante(s) · {got} acquise(s)',
    ...
    tipProof: 'Terminez chaque réponse sur sa preuve — c’est le chiffre que le recruteur note.',
  },
  ...
  settingsData: {
    ...
    salaryAuto: 'Compléter automatiquement à l\'ajout',
    salaryAutoHint: 'Recherche la rémunération sur le web dès qu\'une candidature est ajoutée (nécessite votre clé Claude ; coût par recherche web). Une seule fois par candidature.',
    salaryAutoOn: '✓ Activé',
    salaryAutoOff: 'Désactivé',
    salaryFill: 'Compléter depuis le web',
    salaryFillHint: 'Uniquement les candidatures actives sans rémunération. Recherche web via votre propre clé Claude.',
    salaryFillButton: 'Compléter la rémunération',
    salaryNone: 'Rien à compléter',
    salaryConfirm: 'candidature(s) vont être recherchées sur le web. Chaque recherche utilise votre clé Claude (coût par recherche web).',
    salaryRun: 'Lancer',
    salaryNoKey: 'Ajoutez votre clé Claude dans Réglages → API : la recherche web de rémunération nécessite votre propre clé.',
    salaryFilled: 'complétées',
    salaryEmpty: 'sans donnée',
    salaryErrors: 'erreurs',
    salarySkipped: 'reportées (limite par lot)',
